...
export default function Juices() {
    ...
    const [Item8,setItem8] =useState({imgsrc:"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSl-zoPtjo2fGWO54LBc0SOsVuTtMN4_mUz-Q&usqp=CAU",name:"PINEAPPLE",price:30,rating:1});
    const [heading,setHeading] = useState("JUICES");
    return (
